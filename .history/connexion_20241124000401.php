...
<body>
    <div class="container">
        ...
        <div class="form-box">
            ...
            <div class="form-content" id="formContent">
                ...
                <!-- Titre -->
                <h1 id="formTitle">Mon identifiant</h1>
                ...
                <form method="POST" action="action/traitement.php" onsubmit="return validateForm()">
                <!-- Champ identifiant -->
                <input type="text" class="input-line" id="userInput" required maxlength="19" name="userInput">
                ...
                <a href="#" class="forgot-link">Identifiant oublié ?</a>
    ...
    const inputField = document.getElementById('numericField');
